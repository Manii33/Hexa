...
<div className="w-full md:w-1/4">
  <h2 className="text-2xl font-semibold text-gray-800 mb-6 font-semibold">Categories</h2>
  <div className="flex flex-col gap-1">
    {["Most Popular", "Personal Assistant", "Sales", "Marketing", "Customer Support"].map((cat) => (
      <button
        key={cat}
        className="text-left px-5 py-3 rounded-xl text-sm font-medium text-gray-500 transition-all duration-200 border border-transparent 
                   hover:bg-white hover:text-blue-600 hover:shadow-md hover:border-gray-100 group"
      >
  ...
  <div className="w-full md:w-3/4">
    <h2 className="text-2xl font-semibold text-gray-800 mb-6">Most Popular</h2>
